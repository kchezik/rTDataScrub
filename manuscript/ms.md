...
\begin{linenomath*}
\begin{equation}
	y_{t} = \alpha_{z_{w,a}} + A_{z_{w\prec a}}\cos(2\pi\omega + \tau_{z_{w,a}}\pi) + \eta_{z_{w\prec a}}, \label{eq4}
\end{equation}
\end{linenomath*}
...
\begin{linenomath*}
\begin{equation}
	\eta_{z_{w\prec a}} \sim \mathrm{Student}~t(3, 0, \sigma_{z_{w\prec a}})  \label{eq6}
\end{equation}
\end{linenomath*}
