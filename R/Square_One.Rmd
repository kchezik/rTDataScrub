...
cert = data.frame(percent = perc, typeI, typeII) %>% gather(data = ., key = errorType, value = error, typeI, typeII)
...
df2$certainty = df2$est_source
df2[df2$median<.875 & df2$certainty=="water","certainty"] = "uncertain"
